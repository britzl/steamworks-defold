...
SKIP_CLASSES = ["ISteamClient", "ISteamMatchmakingServerListResponse", "ISteamMatchmakingPingResponse", "ISteamMatchmakingPlayersResponse", "ISteamMatchmakingRulesResponse", "ISteamMatchmakingServers", "ISteamMusicRemote", "ISteamHTTP", "ISteamController", "ISteamAppList", "ISteamHTMLSurface", "ISteamParentalSettings", "ISteamRemotePlay", "ISteamNetworkingMessages", "ISteamNetworkingSockets", "ISteamNetworkingUtils", "ISteamGameServer", "ISteamGameServerStats", "ISteamNetworkingFakeUDPPort", "ISteamInput" ]
